package com.example.assignment2_Shreas_salimraj
...
import com.example.assignment2_Shreas_salimraj.ui.theme.Assignment2shreassalimrajTheme
import com.example.assignment2_shreassalimraj.R

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Assignment2shreassalimrajTheme {
